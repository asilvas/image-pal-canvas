...
var imagePal = __webpack_require__(/*! image-pal/lib/hsluv */ "./node_modules/image-pal/lib/hsluv.js");
...
module.exports = function (imagePal, _ref, cb) {
  var srcUrl = _ref.srcUrl,
      width = _ref.width,
      height = _ref.height,
      imageEl = _ref.imageEl,
      canvasEl = _ref.canvasEl,
      inputEl = _ref.inputEl,
      onProcess = _ref.onProcess,
      options = _objectWithoutProperties(_ref, ["srcUrl", "width", "height", "imageEl", "canvasEl", "inputEl", "onProcess"]);
  ...
  var imgOnLoad = function imgOnLoad() {
    if (width) {
      var aspectY = img.naturalHeight / img.naturalWidth;
      canvas.width = width;
      canvas.height = Math.round(width * aspectY);
    } else {
      var aspectX = img.naturalWidth / img.naturalHeight;
    ...
    var colors = imagePal(imgData.data, _objectSpread({
      hasAlpha: true
    }, options));
    cb(null, colors);
  };

  var imgOnError = function imgOnError(e, err) {
    return cb(err);
  };
  ...
  if (inputEl) {
    inputEvt = function inputEvt(_inputEvt) {
      ...
      reader.readAsDataURL(_inputEvt.target.files[0]);
    };
...
/***/ "./node_modules/image-pal/lib/hsluv.js":
/*!*********************************************!*\
  !*** ./node_modules/image-pal/lib/hsluv.js ***!
  \*********************************************/
/*! no static exports found */
...
var getOptions = __webpack_require__(/*! ./shared/get-options */ "./node_modules/image-pal/lib/shared/get-options.js");

var getColors = __webpack_require__(/*! ./shared/get-colors */ "./node_modules/image-pal/lib/shared/get-colors.js");
...
/***/ "./node_modules/image-pal/lib/shared/get-colors.js":
/*!*********************************************************!*\
  !*** ./node_modules/image-pal/lib/shared/get-colors.js ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./node_modules/image-pal/lib/shared/get-options.js":
/*!**********************************************************!*\
  !*** ./node_modules/image-pal/lib/shared/get-options.js ***!
  \**********************************************************/
/*! no static exports found */
...
window.imagePalCanvasHsluv = _lib_hsluv__WEBPACK_IMPORTED_MODULE_0___default.a;

/***/ })

/******/ });
//# sourceMappingURL=image-pal-canvas-hsluv.js.map